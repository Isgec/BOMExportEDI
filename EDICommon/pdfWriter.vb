      ...
      For Each lstFile As String In PathFileList
        ...
        Try
          ...
          If xlWb IsNot Nothing Then
            ...
            xlAp.ActiveWorkbook.ExportAsFixedFormat(XlFixedFormatType.xlTypePDF, OutputFile, XlFixedFormatQuality.xlQualityStandard, True, True, OpenAfterPublish:=False)
            xlWb.Close(False)
            xlWb = Nothing
          End If
